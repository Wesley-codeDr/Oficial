            ...
            <div className="flex bg-slate-100/80 dark:bg-slate-800/50 p-1 rounded-full border border-slate-200/50 dark:border-white/5">
              ...
              {patient.gender === 'F' && patient.category !== 'pediatric' && patient.category !== 'elderly' && (
                <button
                  ...
                  className={cn(
                    'ml-1 px-3 py-1 rounded-full text-[10px] font-bold transition-all flex items-center gap-1.5',
                    patient.isPregnant
          ...
          <div className="flex flex-wrap items-center gap-2 min-h-[32px]">
            ...
            {isAddingAllergy ? (
              ...
              <button
                ...
                className="w-7 h-7 flex items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-400 hover:text-blue-500 transition-colors border border-slate-200 dark:border-slate-700"
              >
